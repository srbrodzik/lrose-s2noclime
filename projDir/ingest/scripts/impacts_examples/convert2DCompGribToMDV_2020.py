...
gribDir = '/home/disk/bob/impacts/raw/radar/2020/mrms/MergedReflectivityQCComposite'
filePrefix = 'MRMS_MergedReflectivityQCComposite'
extension = 'grib2'
extensionZipped = 'grib2.gz'
ncPrefix = filePrefix.replace('_','.')
ncDirBase = '/home/disk/bob/impacts/netcdf/mrms/2DCompRefl'
        ...
        for gribFile in filesAll:
            ...
            if dateTimeObj >= startObj and dateTimeObj <= stopObj and minutes[-1] in ['7','8']:
                ...
                if os.path.isfile(ncDir+'/'+ncFile):
                    ...
                    # add alt dim to ncFile - still need to add altitude dim to DBZ_comp field
                    ...
                    command = 'NcGeneric2Mdv -v -params '+paramsDir+'/NcGeneric2Mdv.mrms_comp_refl_2020 -f '+ncFile
                    os.system(command)
