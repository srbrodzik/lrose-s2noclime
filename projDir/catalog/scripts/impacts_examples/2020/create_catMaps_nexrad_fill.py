...
# User inputs
start_time_str = '202002291840'
end_time_str   = '202002291850'
...
os.environ['PLATFORM_NAME'] = 'NEXRAD_MOSAIC'
...
os.environ['ORIGIN_LON'] = '-80.25'
os.environ['MINX'] = '-93.0'
os.environ['MAXX'] = '-67.5'
os.environ['MINY'] =  '32.5'
os.environ['MAXY'] =  '46.5'
...
while next_time_obj < end_time_obj:
    ...
    command = 'CIDD -p CIDD.catalog.mosaic_nexrad_archive -i mosaic.web.transparent -fn fixed -v 2'
    os.system(command)
